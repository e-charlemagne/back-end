...
$$
    ...
    BEGIN
        ...
        customer_count := (SELECT COUNT(*) FROM _user WHERE role = 'Customer');
...
$$
    ...
    BEGIN
        FOR i IN 1..100 LOOP
                ...
                INSERT INTO _user (firstname, lastname, username, password, email, role)
                VALUES (firstname, lastname, username, password, email, 'Customer');
            END LOOP;
    END
$$;
